...
| **3** | **Per-brand ambient color** | **This PR.** `data-brand` on `<body>` + CSS variables. Palettes from the live Mercaso rewards screens: Coca-Cola `#f40009`, Monster `#8dc63f` (claw lime, dark type on buttons), Ferrera/Nerds `#e4007c`. Layout/sectioning unchanged; no logos. |
