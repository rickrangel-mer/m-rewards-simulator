...
| **3** | **Per-brand ambient color** | **On `main`, iterating.** Coca-Cola red/white; Monster black chrome + lime highlights; Ferrera/Nerds strawberry + grape + logo blue. Flat gray page (no corner wash). Layout/sectioning unchanged; no logos. |
